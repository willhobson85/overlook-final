...
describe("Bookings", () => {
    ...
    beforeEach( () => {
        booking1 = new Bookings(bookingSample[0].id, bookingSample[0].userID, bookingSample[0].date, bookingSample[0].roomNumber);
        booking2 = new Bookings(bookingSample[1].id, bookingSample[1].userID, bookingSample[1].date, bookingSample[1].roomNumber)
    })
